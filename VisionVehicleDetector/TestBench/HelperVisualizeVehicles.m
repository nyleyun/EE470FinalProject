classdef HelperVisualizeVehicles < matlab.System
    ...
    methods(Access = protected)
        ...
        function frameOut = visualizeVehicles(obj, detectedVehicles, groundTruthVehicles, frame)
            ...
            frameOut = frame;
            textXPos = round(obj.Camera.ImageSize(2)*0.781);
            textYPos = 100;
            % Insert label for detected vehicles.
            frameOut = insertText(frameOut,[textXPos textYPos], 'Detected Vehicles','BoxColor', 'yellow','BoxOpacity',0.5,'TextColor','white','FontSize',18);
            ...
            if obj.EnableTruthDisplay
                ...
                frameOut = insertText(frameOut,[textXPos round(textYPos/2)], 'Ground Truth Vehicles','BoxColor', 'blue','BoxOpacity',0.8,'TextColor','white','FontSize',18);
                bboxes = zeros(20,4);
